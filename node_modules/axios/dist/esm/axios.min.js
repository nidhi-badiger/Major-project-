...
const I = F.toFlatObject(F, {}, null, function (e) {
  ...
  function u(e, n, o) {
    ...
    if (e && !o && "object" == typeof e)
      if (F.endsWith(n, "{}"))
        ...
        (F.isArray(e) &&
          (function (e) {
            return F.isArray(e) && !e.some(L);
          })(e)) ||
        ((F.isFileList(e) || F.endsWith(n, "[]")) && (a = F.toArray(e)))
      )
        return (
          (n = k(n)),
    ...
    return !!L(e) || (t.append(q(o, n, s), c(e)), !1);
  }
  const l = [],
    f = Object.assign(I, {
      defaultVisitor: u,
          ...
          F.forEach(n, function (n, s) {
            !0 ===
              (!(F.isUndefined(n) || null === n) &&
                o.call(t, n, F.isString(s) ? s.trim() : s, r, f)) &&
              e(n, r ? r.concat(s) : [s]);
          }),
          l.pop();
      }
...
const K = class {
  ...
  G = {
    ...
    classes: {
      URLSearchParams:
        "undefined" != typeof URLSearchParams ? URLSearchParams : H,
...
function X(e) {
  function t(e, n, r, o) {
    ...
    const i = Number.isFinite(+s),
      a = o >= e.length;
    if (((s = !s && F.isArray(r) ? r.length : s), a))
      return F.hasOwnProp(r, s) ? (r[s] = [r[s], n]) : (r[s] = n), !i;
...
const Q = {
  ...
  transformRequest: [
    function (e, t) {
      ...
      if (F.isFormData(e)) return r && r ? JSON.stringify(X(e)) : e;
      if (
        F.isArrayBuffer(e) ||
        F.isBuffer(e) ||
        F.isStream(e) ||
...
function ne(e) {
  return !1 === e || null == e ? e : F.isArray(e) ? e.map(ne) : String(e);
}
...
oe.accessor([
  ...
  F.reduceDescriptors(oe.prototype, ({ value: e }, t) => {
...
const fe = G.isStandardBrowserEnv
  ? (function () {
    ...
    function (e) {
      return new Promise(function (t, n) {
        ...
        if (
          ...
          (u.onabort = function () {
            u &&
              (n(new _("Request aborted", _.ECONNABORTED, e, u)), (u = null));
          }),
          (u.onerror = function () {
          ...
          const t =
            (e.withCredentials || fe(l)) &&
            e.xsrfCookieName &&
            ue.read(e.xsrfCookieName);
        ...
        d && -1 === G.protocols.indexOf(d)
          ? n(new _("Unsupported protocol " + d + ":", _.ERR_BAD_REQUEST, e))
          : u.send(r || null);
      });
    },
};
...
const he = (e) => `- ${e}`,
  me = (e) => F.isFunction(e) || null === e || !1 === e,
  ye = (e) => {
    e = F.isArray(e) ? e : [e];
    const { length: t } = e;
    let n, r;
    ...
    for (let s = 0; s < t; s++) {
      ...
      if (
        ((n = e[s]),
        (r = n),
        !me(n) && ((r = pe[(t = String(n)).toLowerCase()]), void 0 === r))
      )
        throw new _(`Unknown adapter '${t}'`);
      if (r) break;
      o[t || "#" + s] = r;
    }
    if (!r) {
...
function be(e) {
  ...
  return ye(e.adapter || Z.adapter)(e).then(
    function (t) {
      return (
        ge(e),
    ...
    function (t) {
      return (
        ae(t) ||
          ...
          t &&
            t.response &&
            ((t.response.data = ie.call(e, e.transformResponse, t.response)),
...
const Ee = (e) => (e instanceof se ? e.toJSON() : e);
function we(e, t) {
  t = t || {};
  const n = {};
  function r(e, t, n) {
...
Oe.transitional = function (e, t, n) {
  function r(e, t) {
    return (
      "[Axios v1.5.1] Transitional option '" + e + "'" + t + (n ? ". " + n : "")
    );
  }
  return (n, o, s) => {
    if (!1 === e)
...
class Te {
  ...
  request(e, t) {
    ...
    let s = o && F.merge(o.common, o[t.method]);
    o &&
      F.forEach(
  ...
  getUri(e) {
    return W(
      le((e = we(this.defaults, e)).baseURL, e.url),
      e.params,
      e.paramsSerializer
    );
  }
...
const Pe = (function t(n) {
  ...
  return (
    F.extend(o, Ce.prototype, r, { allOwnKeys: !0 }),
...
(Pe.Axios = Ce),
  ...
  (Pe.mergeConfig = we),
  (Pe.AxiosHeaders = se),
  (Pe.formToJSON = (e) => X(F.isHTMLForm(e) ? new FormData(e) : e)),
  (Pe.getAdapter = ye),
  (Pe.HttpStatusCode = xe),
  (Pe.default = Pe);
const Ue = Pe,
  {
    Axios: Fe,
